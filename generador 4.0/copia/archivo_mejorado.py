...
center_frame.pack(side="right", fill='both', expand=True, padx=20, pady=20)
right_frame.pack(side='left', fill='y', padx=20, pady=20)
...
random_length_var = tk.BooleanVar()  # 7 - 10
random_length_var2 = tk.BooleanVar()  # 10 - 20
random_length_var3 = tk.BooleanVar()  # 5 - 10
random_length_var4 = tk.BooleanVar()  # 8 - 12
...
random_texts = ["entre 7 y 10", "entre 10 y 20", "entre 5 y 10", "entre 8 y 12", "entre 12 y 16"]
for var, text in zip(random_vars, random_texts):
    tk.Checkbutton(random_frame, text=f"Aleatorias {text}", var=var, bg="#343d46", fg=text_color, selectcolor="#343d46", 
                   command=lambda var=var: toggle_random_length(var, random_vars, text), font=font_type).pack(anchor=tk.W)
